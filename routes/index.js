...
router.get('/:page',async(req,res)=>{
    ...
    const art = []
    try {
        var url = 'http://newsapi.org/v2/top-headlines?category=general&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
        const news_get =await axios.get(url)
        for (let i = 0; i < 100; i++) {
...
const art = []
    try {
            if(req.user.general === 'yes'){
                var url1 = 'http://newsapi.org/v2/top-headlines?category=general&apiKey=36f3e29b704f41339af8439dc1228334';
            ...
            if(req.user.business == 'yes'){
                var url2 = 'http://newsapi.org/v2/top-headlines?category=business&apiKey=36f3e29b704f41339af8439dc1228334';
            ...
            if(req.user.entertainment == 'yes'){
                var url3 = 'http://newsapi.org/v2/top-headlines?category=entertainment&apiKey=36f3e29b704f41339af8439dc1228334';
            ...
            if(req.user.health == 'yes'){
                var url4 = 'http://newsapi.org/v2/top-headlines?category=health&apiKey=36f3e29b704f41339af8439dc1228334';
            ...
            if(req.user.science == 'yes'){
                var url5 = 'http://newsapi.org/v2/top-headlines?category=science&apiKey=36f3e29b704f41339af8439dc1228334';
            ...
            if(req.user.sport == 'yes'){
                var url6 = 'http://newsapi.org/v2/top-headlines?category=sports&apiKey=36f3e29b704f41339af8439dc1228334';
            ...
            if(req.user.technology == 'yes'){
                var url7 = 'http://newsapi.org/v2/top-headlines?category=technology&apiKey=36f3e29b704f41339af8439dc1228334';
...
router.get('/dashboard/home/:page', ensureAuthenticated, async(req,res)=>{
    ...
    try {
        ...
        if(req.user.general === 'yes'){
            var url1 = 'http://newsapi.org/v2/top-headlines?category=general&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
            const news_get =await axios.get(url1)
            for (let i = 0; i < 100; i++) {
                art.push(news_get.data.articles[i])
              } 
        ...
        if(req.user.business == 'yes'){
            var url2 = 'http://newsapi.org/v2/top-headlines?category=business&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
            const news_bus =await axios.get(url2)
            for (let i = 0; i < 100; i++) {
                art.push(news_bus.data.articles[i])
              } 
        ...
        if(req.user.entertainment == 'yes'){
            var url3 = 'http://newsapi.org/v2/top-headlines?category=entertainment&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
            const news_ent =await axios.get(url3)
            for (let i = 0; i < 100; i++) {
                art.push(news_ent.data.articles[i])
              } 
        ...
        if(req.user.health == 'yes'){
            var url4 = 'http://newsapi.org/v2/top-headlines?category=health&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
            const news_hlt =await axios.get(url4)
            for (let i = 0; i < 100; i++) {
                art.push(news_hlt.data.articles[i])
            }
        ...
        if(req.user.science == 'yes'){
            var url5 = 'http://newsapi.org/v2/top-headlines?category=science&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
            const news_sci =await axios.get(url5)
            for (let i = 0; i < 100; i++) {
                art.push(news_sci.data.articles[i])
            } 
        ...
        if(req.user.sport == 'yes'){
            var url6 = 'http://newsapi.org/v2/top-headlines?category=sports&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
            const news_sport =await axios.get(url6)
            for (let i = 0; i < 100; i++) {
                art.push(news_sport.data.articles[i])
            }   
        ...
        if(req.user.technology == 'yes'){
            var url7 = 'http://newsapi.org/v2/top-headlines?category=technology&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
            const news_tech =await axios.get(url7)
            for (let i = 0; i < 100; i++) {
                art.push(news_tech.data.articles[i])
            } 
...
router.get('/dashboard/health/:page',ensureAuthenticated, async(req,res)=>{
    const art = []
    try {
        var url = 'http://newsapi.org/v2/top-headlines?category=health&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
        const news_get =await axios.get(url)
        for (let i = 0; i < 100; i++) {
            art.push(news_get.data.articles[i])
          }
...
router.get('/dashboard/entertainment/:page',ensureAuthenticated, async(req,res)=>{
    const art = []
    try {
        var url = 'http://newsapi.org/v2/top-headlines?category=entertainment&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
        const news_get =await axios.get(url)
        for (let i = 0; i < 100; i++) {
            art.push(news_get.data.articles[i])
          }
...
router.get('/dashboard/science/:page',ensureAuthenticated, async(req,res)=>{
    const art = []
    try {
        var url = 'http://newsapi.org/v2/top-headlines?category=science&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
        const news_get =await axios.get(url)
        for (let i = 0; i < 100; i++) {
            art.push(news_get.data.articles[i])
          }
...
router.get('/dashboard/business/:page',ensureAuthenticated, async(req,res)=>{
    const art = []
    try {
        var url = 'http://newsapi.org/v2/top-headlines?category=business&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
        const news_get =await axios.get(url)
        for (let i = 0; i < 100; i++) {
            art.push(news_get.data.articles[i])
          }
...
router.get('/dashboard/sports/:page',ensureAuthenticated, async(req,res)=>{
    const art = []
    try {
        var url = 'http://newsapi.org/v2/top-headlines?category=sports&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
        const news_get =await axios.get(url)
        for (let i = 0; i < 100; i++) {
            art.push(news_get.data.articles[i])
          }
    ...
    router.get('/dashboard/technology/:page',ensureAuthenticated, async(req,res)=>{
        const art = []
    try {
        var url = 'http://newsapi.org/v2/top-headlines?category=technology&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100';
        const news_get =await axios.get(url)
        for (let i = 0; i < 100; i++) {
            art.push(news_get.data.articles[i])
          }
...
// 			url: "http://newsapi.org/v2/top-headlines?category=general&apiKey=36f3e29b704f41339af8439dc1228334",
// 			method: "get",
// 		});
...
router.get("/news/users/:id", async (req, res) => {
  ...
  router.post('/search/1',ensureAuthenticated, async (req,res)=>{
    ...
    try {
        if(search.length > 0){
            var url = `http://newsapi.org/v2/everything?q=${search}&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100`
            const news_get =await axios.get(url)
...
router.get("/news/category/:category", async (req, res) => {
    ...
    try {
		const response = await axios({
			url: "http://newsapi.org/v2/top-headlines?category=" + category + "&apiKey=36f3e29b704f41339af8439dc1228334&pageSize=100",
			method: "get",
		});
